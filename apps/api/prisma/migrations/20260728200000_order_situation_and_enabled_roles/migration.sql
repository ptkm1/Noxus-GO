-- AlterTable
ALTER TABLE "Organization" ADD COLUMN "enabledRoles" JSONB NOT NULL DEFAULT '["ADMIN","MANAGER","SELLER"]';
...
-- CreateIndex
CREATE INDEX "OrderSituation_organizationId_active_idx" ON "OrderSituation"("organizationId", "active");
